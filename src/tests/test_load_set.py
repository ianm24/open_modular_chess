...
class TestLoadSet(unittest.TestCase):
    def test_incorrect_set_name(self):
        ...
        self.assertEqual(load_set.load_set(
            "test_sets/test_set_incorrect_set_name"), [[], (SEC, lsMEC, 1)])
...
class TestGetPieceNames(unittest.TestCase):
    def test_missing_pieces_directory(self):
        ...
        self.assertEqual(load_set.get_piece_names(
            "test_sets/test_set_missing_pieces_directory"), [[], (SEC, gpnMEC, 1)])

    # TODO make this test work while keeping the directory in repository
...
class TestGetBoard(unittest.TestCase):
    def test_missing_board_file(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_missing_board_file"), [[], (SEC, gbMEC, 1)])
    ...
    def test_board_column_dimension_type(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_board_column_dimension_type"), [[], (SEC, gbMEC, 5)])
    ...
    def test_invalid_board_layout_value(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_invalid_board_layout_value"), [[], (SEC, gbMEC, 6)])

    def test_invalid_board(self):
        # Ensures proper function when a set has a board with non-integer column dimension
        errorcodes = load_set.get_board(
            "test_sets/test_set_extra_values_board")
        get_board_errorcode = (
            errorcodes[1][0], errorcodes[1][1], errorcodes[1][2])
...
class TestValidateBoard(unittest.TestCase):
    def test_extra_values_board(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_extra_values_board"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 1))])

    def test_nonpos_board_dimension(self):
        # Ensures proper function when a set has a board with non-positive dimensions
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_nonpos_board_dimension_1"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 2))])
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_nonpos_board_dimension_2"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 2))])
    ...
    def test_board_layout_num_rows(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_board_layout_num_rows"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 3))])
    ...
    def test_board_layout_num_cols(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_board_layout_num_cols"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 4))])
    ...
    def test_nonstring_board_piece(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_nonstring_board_piece"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 5))])
    ...
    def test_invalid_player_prefix_board_piece(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_invalid_player_prefix_board_piece"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 6))])
    ...
    def test_invalid_player_suffix_board_piece(self):
        ...
        self.assertEqual(load_set.get_board(
            "test_sets/test_set_invalid_player_suffix_board_piece"), [[], (SEC, gbMEC, 7, (SEC, vbMEC, 7))])
    ...
    def test_validate_board(self):
        ...
        base_set_board = [8, 8, [
            ...
            ['p1_pawn', 'p1_pawn', 'p1_pawn', 'p1_pawn',
                'p1_pawn', 'p1_pawn', 'p1_pawn', 'p1_pawn'],
            ['p1_rook', 'p1_knight', 'p1_bishop', 'p1_king', 'p1_queen', 'p1_bishop', 'p1_knight', 'p1_rook']]]
        self.assertEqual(load_set.validate_board(
            base_set_board, "base_set"), [True, None])
